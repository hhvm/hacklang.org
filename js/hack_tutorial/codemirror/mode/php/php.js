(function() {
  ...
  var phpConfig = {
    name: "clike",
    keywords: keywords("abstract and array as async await break case catch class clone const continue declare default " +
